                    ...
                    <el-row type="flex" class="row-bg" >
                        ...
                        <el-col :span="11">
                            <el-form-item label="用户名" prop="loginName">
                                 <el-input :readonly="this.$route.query.type == 'view'" v-model="form.loginName" placeholder="用户名为非必填项，如果不填写，会根据公司中文名称的首字母自动生成。"></el-input>
                              </el-form-item>
                        </el-col>
                         <el-col :span="11">
                            <el-form-item label="公司中文名" prop="suppChineseName">
                                 <el-input v-model="form.suppChineseName" :readonly="this.$route.query.type == 'view'"></el-input>
                            </el-form-item>
                        </el-col>                                        
                    </el-row>
                     ...
                     <el-row type="flex" class="row-bg" >
                        <el-col :span="11">
                            <el-form-item label="供应商简称" prop="suppAliaName">
                                 <el-input v-model="form.suppAliaName" :readonly="this.$route.query.type == 'view'"></el-input>
                              </el-form-item>
                        </el-col>
                         <el-col :span="11">
                            <el-form-item label="公司英文名" prop="suppEnglishName">
                                 <el-input v-model="form.suppEnglishName" :readonly="this.$route.query.type == 'view'"></el-input>
                              </el-form-item>
                        </el-col>                                           
                    </el-row>
                   ...
                   <!--  <el-row type="flex" class="row-bg" justify="space-between">                 
                     ...
                     <el-row type="flex" class="row-bg">                  
                          ...
                          <el-form-item label="传真号码" prop="suppFax">
                                  <el-input v-model="form.suppFax" :readonly="this.$route.query.type == 'view'"></el-input>
                            </el-form-item>
                        </el-col>                         
                        <el-col :span="11">
                           <el-form-item label="详细地址" prop="suppAddress">
                                <el-input  v-model="form.suppAddress" :readonly="this.$route.query.type == 'view'"></el-input>
                            </el-form-item>
                        </el-col>
                     ...
                     <el-row type="flex" class="row-bg">                       
                        <el-col :span="6">
                           <el-form-item label="注册资金(万元)" prop="registeredCapital" >
                                ...
                                <el-input  v-model="form.registeredCapital" type="number"  placeholder="请输入数值" :readonly="this.$route.query.type == 'view'">                                  
                                </el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                        ...
                        <el-col :span="11">
                           <el-form-item label="经营范围" prop="businessScope">
                                <el-input v-model="form.businessScope" :readonly="this.$route.query.type == 'view'"></el-input>
                            </el-form-item>
                        </el-col>                                      
                    </el-row>
                      ...
                      <el-row type="flex" class="row-bg" > 
                         <el-col :span="11">
                           <el-form-item label="备注" prop="remarks">
                                  <el-input v-model="form.remarks" :readonly="this.$route.query.type == 'view'"></el-input>
                            </el-form-item>
                        </el-col>  
                        <el-col :span="11">
                           <el-form-item label="供应商K3编号" prop="suppK3Code" v-show="isShowK3Code">
                                  <el-input v-model="form.suppK3Code" :readonly="this.$route.query.type == 'view'"></el-input>
                            </el-form-item>
                        </el-col>                                                                                      
                    </el-row>
          ...
          >
            ...
            >
              <el-col :span="8">
                ...
                >
                  <el-input v-model="form.suppContactName" :readonly="this.$route.query.type == 'view'"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item
                  ...
                  prop="suppMobile"
                >
                  <el-input v-model="form.suppMobile" :readonly="this.$route.query.type == 'view'"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item
                  ...
                  prop="suppEmail"
                >
                  <el-input v-model="form.suppEmail" :readonly="this.$route.query.type == 'view'"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row
            ...
            >
              <el-col :span="8">
                <el-form-item
                  ...
                  prop="suppPosition"
                >
                  <el-input v-model="form.suppPosition" :readonly="this.$route.query.type == 'view'"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item
                  ...
                  prop="suppSex"
                >
                  <el-input v-model="form.suppSex" :readonly="this.$route.query.type=='view'"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
            ...
            >
              <el-col :span="11">
                <el-form-item
                  ...
                  prop="accountName"
                >
                  <el-input v-model="form.accountName" :readonly="this.$route.query.type=='view'"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="11">
                <el-form-item
                  ...
                  prop="bankAccount"
                >
                  <el-input v-model="form.bankAccount" :readonly="this.$route.query.type=='view'"></el-input>
                </el-form-item>
              </el-col>
            ...
            >
              <el-col :span="11">
                <el-form-item
                  ...
                  prop="bsInvoiceTitle"
                >
                  <el-input v-model="form.bsInvoiceTitle" :readonly="this.$route.query.type=='view'"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="11">
                <el-form-item
                  label="纳税人识别号"
                  prop="bsTaxpayerNumber"
                >
                  <el-input v-model="form.bsTaxpayerNumber" :readonly="this.$route.query.type=='view'"></el-input>
                </el-form-item>
              </el-col>
            ...
            >
              <el-col :span="11">
                <el-form-item
                  ...
                  prop="city"
                >
                  <el-input v-model="form.city" :readonly="this.$route.type=='view'"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="11">
                <el-form-item
                  ...
                  prop="depositBank"
                >
                  <el-input v-model="form.depositBank" :readonly="this.$route.type=='view'"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row
            ...
            >
              <el-col :span="11">
                <el-form-item
                  ...
                  prop="payMethod"
                >
                  <el-input v-model="form.payMethod" :readonly="this.$route.type=='view'"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="11">
                <el-form-item
                  ...
                  prop="depositBank"
                >
                  <el-input v-model="form.payCondition" :readonly="this.$route.type=='view'"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
import { addSupplierInfo, editSupplier, getSupplierByCurrUser } from "@/api/supplier";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        loginName: [{ required: true, trigger: "blur",validator:checkName }],
  ...
  created() {
    if (this.$route.query.type) {
      ...
      if(this.$route.name=="Dashboard"){
        ...
        getSupplierByCurrUser().then(response => {
          if(response.result){
