<template>
    <div>
        <el-card style="padding-bottom: 0;border:none;height: auto;">
            <el-row>
                <el-col :span="24">
                    <el-form :inline="true" :model="formQuery" class="demo-form-inline">
                      ...
                      <el-form-item>
                        <el-select v-model="formQuery.userType" placeholder="请选择" style="width:280px">
...
import {getRoleList,getCheckedRoles,saveUserRoles} from '@/api/role'
  ...
  export default {
    ...
    getData(){       
        getUserList(this.formQuery.userCode,this.formQuery.userName,this.formQuery.userType,this.queryParams.rows,this.queryParams.page).then(response => {
            if (!response.data) { 
            reject('error')
          }            
...
/*编辑*/
    showEditDialog() {  
        ...
        this.dialog.formItem.userStatus=r.userStatus.toString();
