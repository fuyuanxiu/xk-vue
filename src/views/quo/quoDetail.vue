                       ...
                       <ul class="s-ul">
                          ...
                          <li>
                           ...
                           <li>
                             ...
                             <span class="li-cont" style="color:blue">{{quoteData.qtTotalPrice}}</span>
                          </li>
                       </ul>    
                  </div>
           <!--  报价明细 -->
                    <div class="detail-table">
                        ...
                        <el-table-column
                          ...
                          <template slot-scope="scope">
                            <el-tag type="danger" v-if="scope.row.bsTaxUnitPrice==null">未报价</el-tag>
                            <el-tag v-else>{{scope.row.bsTaxUnitPrice}}</el-tag>
                          </template>
                        </el-table-column>
                        <el-table-column
                          ...
                          width="140">
                          <template slot-scope="scope">
                            <el-tag type="danger" v-if="scope.row.bsTaxTotalPrice==null">未报价</el-tag>
                            <el-tag v-else>{{scope.row.bsTaxTotalPrice}}</el-tag>
                          </template>
                        </el-table-column>
                        <el-table-column
                         ...
                         <li>
                          ...
                          <li>
                           ...
                           <li>
                             ...
                             <span class="li-cont" style="color:blue">{{enquiryData.eqTaxPoint}}</span>
                          </li>
                           <li>
