<template>
  <div element-loading-text="数据加载中，请稍等">
            ...
            >
              <el-col :span="24" style="margin-bottom:-10px;margin-top:5px;">
                <el-form-item label="客户">
                   <el-input v-model="formQuery.bsCustomer" style="width:170px"></el-input>
                </el-form-item>
                <el-form-item label="机型">
                   <el-input v-model="formQuery.bsMachine" style="width:170px"></el-input>
                </el-form-item>
                <el-form-item label="BOM单">
                   <el-input v-model="formQuery.bsBomCode" style="width:170px" :readonly="true"></el-input>
                </el-form-item>
                <el-form-item label="文件ID" style="display: none;">
                   <el-input v-model="formQuery.bsFileId" style="width:170px" :readonly="true"></el-input>
                </el-form-item>
              ...
              <el-col>                               
                <el-form-item style="margin-left:40px;">
                  <!-- <el-button type="primary" @click="doSave()">保存设置</el-button> -->
                  <el-button type="primary" @click="showAdd()">新增工序流</el-button>
    ...
    <el-table :data="iTable" class="market-table">
      ...
      <el-table-column prop="bsProject" label="项目" width="100" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column label="操作"  width="100" fixed="right">
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" circle @click="showEdit(scope.row)" title="编辑"></el-button>
          <messagebox 
    ...
    <!-- fyx-新增工序 -->
    <el-dialog title="新增工序" :visible.sync="add_dialog.dataVisible" width="500px">
      <el-form
      :model="addForm"
      ...
      label-width="110px">
        <el-form-item label="机型" prop="bsMachine" label-position="left">
          <el-input v-model="addForm.bsMachine" style="width:218px;" :disabled="true"></el-input>
        </el-form-item>             
    ...
    <!-- 新增详情 -->
    <el-dialog title="新增详情" :visible.sync="dialog.dataVisible" width="500px">
      <el-form
      :model="dataForm"
      ...
      label-width="110px">
        <el-form-item label="机型" prop="bsMachine" label-position="left">
          <el-input v-model="dataForm.bsMachine" style="width:218px;" :disabled="true"></el-input>
        </el-form-item>             
        ...
        <el-form-item label="数量" prop="bsQty">
          <el-input v-model="dataForm.bsQty" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单位" prop="bsUnit">
          <el-input v-model="dataForm.bsUnit" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单价(50K)" prop="price1">
          <el-input v-model="dataForm.price1" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单价(5K)" prop="price2">
          <el-input v-model="dataForm.price2" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单价(<1000)" prop="price3">
          <el-input v-model="dataForm.price3" style="width:218px;"></el-input>
        </el-form-item>
    ...
    <!-- 编辑详情 -->
    <el-dialog title="编辑详情" :visible.sync="dialogEdit.dataVisible" width="500px">
      <el-form
      :model="dataFormEdit"
      ...
      label-width="110px">
        <el-form-item label="机型" prop="bsMachine" label-position="left">
          <el-input v-model="dataFormEdit.bsMachine" style="width:218px;" :disabled="true"></el-input>
        </el-form-item>             
        <el-form-item label="项目" prop="bsProject" label-position="left">
          <el-input v-model="dataFormEdit.bsProject" style="width:218px;" :disabled="true"></el-input>
        </el-form-item>   
        <el-form-item label="规格(计费)" prop="bsFeeName">
          <el-input v-model="dataFormEdit.bsFeeId" style="width:218px;" :disabled="true"></el-input>
        </el-form-item>         
        <el-form-item label="规格(计费)" prop="bsFeeId">
          <el-input v-model="dataFormEdit.bsFeeId" style="width:218px;" :disabled="true"></el-input>
        </el-form-item> 
        <el-form-item label="数量" prop="bsQty">
          <el-input v-model="dataFormEdit.bsQty" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单位" prop="bsUnit">
          <el-input v-model="dataFormEdit.bsUnit" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单价(50K)" prop="price1">
          <el-input v-model="dataFormEdit.price1" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单价(5K)" prop="price2">
          <el-input v-model="dataFormEdit.price2" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="单价(<1000)" prop="price3">
          <el-input v-model="dataFormEdit.price3" style="width:218px;"></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="bsRemark">
...
export default {
  ...
  methods: {
    ...
    //保存
    doSave(){
      let filter = Object.assign({},this.formQuery);
    ...
    getDetailList(){
      if(this.formQuery.id){
        let filter=Object.assign({},{keyword:"",fileId:this.formQuery.bsFileId,reportId:this.formQuery.id,rows:this.queryParams.rows,page:this.queryParams.page})      
